 define({
	...
	texts: {
		...
		faults: {
			...
			401: 'Эта операция не может  быть проведена ,потому что это может привести к отправке private key удалённому NIS.',
			404: 'Неправильное значение загрузки',
			500: 'Невозможно сохранить файл конфигурации',Кошелёк уже содержит этот аккаунт
